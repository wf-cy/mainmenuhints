...
declare type ActionFactory = (actionConfig: PopmotionTransitionProps) => Action;
 ...
 * @internal
 */
declare class ComponentAnimationControls<P extends {} = {}, V extends {} = {}> {
    /**
 ...
 * @internal
 */
export declare const createMotionComponent: <P extends {}>({ useFunctionalityComponents, }: MotionComponentConfig) => React.ForwardRefExoticComponent<React.PropsWithoutRef<P & MotionProps> & React.RefAttributes<Element>>;
...
declare class MotionValuesMap {
    ...
    bindValueToStyler(key: string, value: MotionValue): void;
...
declare type PopmotionTransitionProps = Tween | Spring | Keyframes | Physics | Inertia | Just;
 ...
 * @public
 */
declare type TransitionDefinition = Tween | Spring | Keyframes | Physics | Inertia | Just | None;
...
declare type UseFunctionalityComponents<P = {}> = (props: P & MotionProps, values: MotionValuesMap, controls: ComponentAnimationControls<P>, ref: RefObject<Element | null>, style: CSSProperties, isStatic?: boolean) => ReactElement<P>[];
